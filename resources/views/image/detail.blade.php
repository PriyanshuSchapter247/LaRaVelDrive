                    ...
                    <div class="col-md-12">
                        <div class="row featurette">
                            ...
                            @if($image)
                                ...
                                @elseif(empty($image-> deleted_at))
{{--                                                                        {{dd($image)}}--}}

                                    <div class="card" style="width: 18rem; margin-left: 37%; margin-top:10%">
                                        <div class="card-body">
                                            <h1 class="card-title" style="margin-left: 40%;">!OOPS</h1>
                                            <p class="card-text" style="margin-left: 17%;">Owner is delete this
                                                image</p>
                                            <a href="{{route('home')}}" style="margin-left: 37%;"
                                               class="btn btn-primary">Home</a>
                                        </div>
                                    </div>
                                    {{--//Condition Check Image is  not null--}}
...
{{--                                    --}}
                            ...
                            @elseif (auth()->user()->id == $image->	created_by)
{{--                                {{dd($image)}}--}}
                                <div class="col-md-12">
                                    <center><img style="height:10%; width:10%"
                                                 src={{ asset('images/images/' . $image->image) }} alt=""></center>
